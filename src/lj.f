...
C      ENDIF
      ...
      DO J1=1,NATOMS
         ...
         ELSE
            ...
            ENDDO
            DIST=X(J3-2)**2+X(J3-1)**2+X(J3)**2
            IF ((DIST.GT.RADIUS).AND.(.NOT.LJMFT)) THEN
               DUMMYX=DUMMYX+10.0D2*16.0D0*(DIST-RADIUS)*X(J3-2)
               DUMMYY=DUMMYY+10.0D2*16.0D0*(DIST-RADIUS)*X(J3-1)
               DUMMYZ=DUMMYZ+10.0D2*16.0D0*(DIST-RADIUS)*X(J3)
            ENDIF
            V(J3-2)=DUMMYX
            V(J3-1)=DUMMYY
            V(J3)=DUMMYZ
