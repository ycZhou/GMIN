...
cc      Exij=energy(rij,ix,0)
      ...
      sf=dy/dxy
        ...
        IF (NEON) THEN
           call energy(rjj0,Esu,Esg,Epu,Epg,Ex,Esu1,Esg1,Epu1,Epg1,Ex1)
        ELSE
...
cc      Ex=energy(rjj0,ix,0)
   ...
   2      continue
      ...
      sf=dy/dxy
        ...
        IF (NEON) THEN
           call energy(rii0,Esu,Esg,Epu,Epg,Ex,Esu1,Esg1,Epu1,Epg1,Ex1)
        ELSE
...
c ne2+su.dat  ne2+sg.dat  ne2+pu.dat  ne2+pg.dat  ne2x.dat   
      ...
      subroutine energy(r,Esu,Esg,Epu,Epg,Ex,Esu1,Esg1,Epu1,Epg1,Ex1)
      implicit DOUBLE PRECISION (a-h,o-z)
...
cc      Ex=energy(rkl,ix,0)
      ...
      sf=dy/dxy
        ...
        IF (NEON) THEN
           call energy(rkl,Esu,Esg,Epu,Epg,Ex,Esu1,Esg1,Epu1,Epg1,Ex1)
        ELSE
